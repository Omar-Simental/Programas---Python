...
print('\nAcceder renglón  \n')
print(fifasm.loc['G. Frabotta'])  # No existe el keyname "Marcelo" lo cambie por G. Frabotta
print('\nAcceder renglones continuos \n')
...
print('Último renglon y ultima columna  : ', fifasm.iat[96,17] ) # En el renglon 97 me marca que esta fuera de los limites 
...
print(fifasm.groupby('shooting')[['wage_eur','value_eur']].sum().sort_values(ascending=False, by='wage_eur'))
