...
print(f'c1: {c1} interseccion c2: {c2} = {c4}')
c5 = c2 & c3
...
print(f'c1: {c1} diferencia simetrica c2: {c2} = {c4}')
c5 = c2 ^ c3
print(f'c2: {c2} diferencia simentrica c3: {c3} = {c5}')
c4.clear();c5.clear();
...
print(f'c4: {c1} es superconjunto de c1: {c4}   : {c1.issuperset(c4)} {c1>=c4}')
